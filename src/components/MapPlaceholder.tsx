    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          {/* Modal Container */}
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 pt-24">
            <motion.div
              className="relative w-full max-w-[1200px] max-h-[90vh] bg-white rounded-lg shadow-2xl border-2 border-[#4B306A] overflow-hidden"
