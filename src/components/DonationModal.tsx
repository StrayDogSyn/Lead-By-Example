                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/70">
                      Your support means everything to our community. You&apos;ll receive a receipt
                      via email.
                    </p>
                  </div>
                </div>
            ...
            <div className="rounded-xl border border-[#01514C]/50 bg-[#01514C]/20 p-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-white/80">
                  Your donation directly supports the All Sides of Town Cookout 2025, providing free
                  food, haircuts, activities, and backpack giveaways for youth in our community.
                </p>
              </div>
            </div>
